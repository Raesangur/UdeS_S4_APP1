...
HD_PWD='/home/raesangur/github/UdeS_S4_APP1/Atelier/atelier/atelier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit_compteur.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circuit_compteur.tcl
